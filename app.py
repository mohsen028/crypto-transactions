...
if نوع_ارز_واریزی == "تومان":
    ...
    مقدار_واریز_پاک = st.number_input("مقدار واریز (دلار)", value=0.0, min_value=0.0, step=0.01, format="%.2f")
    مقدار_واریز = f"{مقدار_واریز_پاک:.2f}"
    st.write(f"💵 مقدار وارد شده: {مقدار_واریز} دلار")

else:
    مقدار_واریز_پاک = st.number_input(f"مقدار واریز ({نوع_ارز_واریزی})", value=0.0, min_value=0.0, step=0.00000001, format="%.8f")
...
مقدار_تتر = st.number_input("مقدار تتر دریافتی", value=0.0, min_value=0.0, step=0.0001, format="%.4f")

# نرخ تبدیل تتر به تومان
نرخ_تتر = st.number_input("💱 نرخ تبدیل تتر به تومان", value=0.0, min_value=0.0, step=100.0, format="%.0f")
if نرخ_تتر:
    st.write(f"🔹 نرخ وارد شده: {نرخ_تتر:,.0f} تومان")

# محاسبه کارمزد پنهان
ارزش_واقعی_تتر = مقدار_تتر * نرخ_تتر
کارمزد_پنهان = مقدار_واریز_پاک - ارزش_واقعی_تتر if مقدار_واریز_پاک else 0
