...
# --- NEW: Combined CSS for both the Vertical Bar and the Badge ---
st.markdown("""
<style>
...
/* 2. The small transaction type badge */
.tx-badge {
...
# --- Two mapping dictionaries are now needed ---
TYPE_TO_CARD_CLASS = {
...
if st.session_state.confirming_delete_id:
    ...
    for index, row in transactions.iterrows():
        # --- MODIFIED: The main div now gets the card class for the vertical bar ---
        ...
        with c1:
            ...
            # Use columns for alignment of name and badge
