...
def generate_financial_analysis(transactions, prices):
    ...
    # ... (fee calculation logic remains the same)
    ...
    if not acquisitions.empty:
        ...
        cost_basis = pd.DataFrame(columns=['person_name', 'currency', 'total_cost_usd', 'total_amount_crypto', 'avg_buy_price'])
    ...
    # This merge will now always work because cost_basis always has the required columns
    ...
    # ... (rest of the function for realized_pnl and fee_summary)
