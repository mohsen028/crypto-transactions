...
def _ensure_data_types(df):
    """This function is the ultimate safeguard. It ensures the DataFrame has the correct columns and data types."""
    expected_cols = {
...
# --- The Complete and Final Analysis Function ---
def generate_financial_analysis(transactions, prices):
    ...
    if not disposals.empty and 'avg_buy_price' in disposals.columns:
